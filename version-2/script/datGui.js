...
export function initDatGui() {
    ...
    perspectiveCameraFolder.add(gameData.camera.position, 'y', -20, 20, 0.1);
    perspectiveCameraFolder.add(gameData.camera.position, 'z', -20, 20, 0.1);
    perspectiveCameraFolder.add(gameData.camera.rotation, 'x', -20, 20, 0.1);
    perspectiveCameraFolder.add(gameData.camera.rotation, 'y', -20, 20, 0.1);
    perspectiveCameraFolder.add(gameData.camera.rotation, 'z', -20, 20, 0.1);
